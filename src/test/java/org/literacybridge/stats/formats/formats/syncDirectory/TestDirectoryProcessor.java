...
public class TestDirectoryProcessor {
  ...
  public void testEndToEnd() throws IOException {
    ...
    final File testRoot = new File(
        "src/test/resources/testSyncDir/testDevice/collected-data".replace('/', File.separatorChar));
    final File talkingBookDir = new File(testRoot,
                                         "2013-03" + File.separator + "Baazu-Jirapa" + File.separator + "TB0002FE");

    final File logTxtFile2 = new File(talkingBookDir,
                                     "11m14d18h45m55s" + File.separator + "log" + File.separator + "log.txt");
    final File logTxtFile = new File(talkingBookDir,
                                     "8m30d17h9m8s" + File.separator + "log" + File.separator + "log.txt");

    final File logArchiveFile = new File(talkingBookDir, "8m30d17h9m8s" + File.separator + "log-archive");
    ...
    processor.process("TestSyncDevice", testRoot);
